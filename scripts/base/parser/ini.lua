    ...
    for line in File.lines(filename) do
        ...
        if headerName ~= nil then
            ...
            if key ~= nil and value ~= nil then
                ...
                data[currentHeaderName][key] = parsedValue
...
-- function iniParser.write(filename,data)
    ...
    -- Write everything
    -- local success,message = love.filesystem.write(filename,dataString)
